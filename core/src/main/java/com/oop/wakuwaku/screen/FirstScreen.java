...
public class FirstScreen extends ScreenAdapter {
    ...
    // Assets (lấy từ GameAssetManager)
    ...
    @Override
    public void show() {
        // Lấy asset từ manager
        backgroundTexture = GameAssetManager.getTexture(GameAssetManager.BACKGROUND);
        characterTexture = GameAssetManager.getTexture(GameAssetManager.CAT);
        dropTexture = GameAssetManager.getTexture(GameAssetManager.HEART);

        dropSound = GameAssetManager.getSound(GameAssetManager.DROP_SOUND);
        music = GameAssetManager.getMusic(GameAssetManager.BGM);
        ...
        characterSprite.setPosition(3, 1); // vị trí ban đầu
